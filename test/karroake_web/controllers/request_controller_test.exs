defmodule KarroakeWeb.RequestControllerTest do
  ...
  @create_attrs %{firstname1: "some firstname1", firstname2: "some firstname2", firstname3: "some firstname3", in_set: true, secondname1: "some secondname1", secondname2: "some secondname2", secondname3: "some secondname3"}
  ...
  describe "update request" do
    ...
    test "redirects when data is valid", %{conn: conn, request: request} do
      ...
      assert html_response(conn, 200) =~ "some updated firstname1"
    end
